...
# Data prep
try:
    df1 = pd.read_excel("usuarios_2025-10-25.xlsx")
    df2 = pd.read_excel("usuarios_2025-10-25 (1).xlsx")
...
html.append("<p><strong>Enlace Tecnico 1:</strong> Adriana Thuman - Cantidad de Afinidades: <strong>186</strong></p>")
